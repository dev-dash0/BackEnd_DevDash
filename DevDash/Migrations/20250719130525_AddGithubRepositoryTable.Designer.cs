...
namespace DevDash.Migrations
{
    ...
    [Migration("20250719130525_AddGithubRepositoryTable")]
    partial class AddGithubRepositoryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevDash.model.GitHubIntegration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("GitHubEmailOrProfile")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("GitHubIntegration");
                });

            modelBuilder.Entity("DevDash.model.GitHubRepository", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DevDash.model.User", b =>
                {
                    ...
                    b.Property<int?>("PersonalTenantId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("statepricing")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("PersonalTenantId")
                        .IsUnique()
                        .HasFilter("[PersonalTenantId] IS NOT NULL");
            ...
            modelBuilder.Entity("DevDash.model.User", b =>
                {
                    b.HasOne("DevDash.model.Tenant", "PersonalTenant")
                        .WithOne()
                        .HasForeignKey("DevDash.model.User", "PersonalTenantId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("PersonalTenant");
                });
